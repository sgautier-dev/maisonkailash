	...
	return (
		<main>
			...
			<ServiceBookingSection
				title="Un format avec préparation des pochons"
				description="Le tarif inclut le massage, la préparation des pochons et le questionnaire."
				practitioner="Lou"
				...
				items={[
					{
						label: "1 heure 30",
						value: "100 €",
						description: "Préparation des pochons et questionnaire.",
					},
				]}
